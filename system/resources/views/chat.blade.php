                                        ...
                                        <ul class="mailbox list-style-none">
                                            <li>
                                                <div class="message-center">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                        <div class="user-img"><img src="public/assets/images/users/5.jpg"
                                                                alt="user" class="img-fluid rounded-circle"
                                                                width="40px"> <span
                                                                class="profile-status online float-right"></span>
                                                        </div>
                                                        <div class="w-75 d-inline-block v-middle pl-2">
                                                            <h6 class="message-title mb-0 mt-1">Bisma Karisma</h6>
                                                            <span
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                        <div class="user-img"><img src="public/assets/images/users/8.jpg"
                                                                alt="user" class="img-fluid rounded-circle"
                                                                width="40px"> <span
                                                                class="profile-status busy float-right"></span>
                                                        </div>
                                                        <div class="w-75 d-inline-block v-middle pl-2">
                                                            <h6 class="message-title mb-0 mt-1">Mega Krismiyati</h6>
                                                            <span
                                                                class="font-12 text-nowrap d-block text-muted text-truncate">Just see the my new admin!
                                                            </span>
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        ...
                                                        <div class="w-75 d-inline-block v-middle pl-2">
                                                            <h6 class="message-title mb-0 mt-1">Angelina Shopi</h6>
                                                            <span
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                        <div class="user-img"><img src="public/assets/images/users/3.jpg"
                                                                alt="user" class="img-fluid rounded-circle"
                                                                width="40px"> <span
                                                                class="profile-status offline float-right"></span>
                                                        </div>
                                                        <div class="w-75 d-inline-block v-middle pl-2">
                                                            <h6 class="message-title mb-0 mt-1">Ariandi Muhammad</h6>
                                                            <span
                                                                class="font-12 text-nowrap d-block text-muted text-truncate">Just
                                                                see the my admin!</span>
                                        ...
                                        <ul class="chat-list list-style-none px-3 pt-3">
                                            ...
                                            <li class="chat-item list-style-none mt-3">
                                                <div class="chat-img d-inline-block"><img
                                                        src="public/assets/images/users/5.jpg" alt="user"
                                                        class="rounded-circle" width="45">
                                                </div>
                                                <div class="chat-content d-inline-block pl-3">
                                                    <h6 class="font-weight-medium">Bisma Karisma</h6>
                                                    <div class="msg p-2 d-inline-block mb-1">Produk kita hari ini harus habis semua.</div>
                                                </div>
                                            ...
                                            <li class="chat-item list-style-none mt-3">
                                                <div class="chat-img d-inline-block"><img
                                                        src="public/assets/images/users/8.jpg" alt="user"
                                                        class="rounded-circle" width="45">
                                                </div>
                                                <div class="chat-content d-inline-block pl-3">
                                                    <h6 class="font-weight-medium">Mega Krismiyati</h6>
                                                    <div class="msg p-2 d-inline-block mb-1">Yes, harus itu supaya kita kembali menyetok barang.</div>
                                                </div>
                                            ...
                                            <li class="chat-item odd list-style-none mt-3">
                                                <div class="chat-content text-right d-inline-block pl-3">
                                                    <div class="box msg p-2 d-inline-block mb-1">
                                                        Kita harus bekerja sama dalam team.</div>
                                                    <br>
                                                </div>
                                            </li>
                                            <!--chat Row -->
                                            <li class="chat-item odd list-style-none mt-3">
                                                <div class="chat-content text-right d-inline-block pl-3">
                                                    <div class="box msg p-2 d-inline-block mb-1 box">
                                                        Harus semangat demi kebutuhan masyarakat.</div>
                                                    <br>
                                                </div>
                                            ...
                                            <li class="chat-item list-style-none mt-3">
                                                ...
                                                <div class="chat-content d-inline-block pl-3">
                                                    <h6 class="font-weight-medium">Angelina Shopi</h6>
                                                    <div class="msg p-2 d-inline-block mb-1">Semangat Semangat Semangat Kerja Kerja Kerja
                                                    </div>
                                                </div>
