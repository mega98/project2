                        ...
                        <form class="mt-4">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn btn-block btn-dark"><a href="dashboard">Sign Up</a></button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                    Already have an account? <a href="#" class="text-danger"><a href="login-admin">Sign In</a></a>
                                </div>
                            </div>
                        </form>
                    </div>
