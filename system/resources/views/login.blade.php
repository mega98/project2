...
<!--===============================================================================================-->	
	<link rel="icon" type="{{url('public')}}/image/png" href="{url('public')}}/images/icons/favicon.ico"/>
<!--===============================================================================================-->
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="login100-form-social flex-c-m">
						<a href="#" src="public/images/fb.jpg" class="login100-form-social-item flex-c-m bg1 m-r-5">
							<i class="fa fa-facebook-f" aria-hidden="true"></i>
						</a>

						<a href="#" src="public/images/fb.jpg" class="login100-form-social-item flex-c-m bg2 m-r-5">
